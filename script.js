...
let input = document.getElementById("mem-address");
...
function readAddress() {
	...
	document.getElementById("hit-one").innerHTML = parseFloat(
		hits[0] / total
	).toFixed(2);
	document.getElementById("hit-two").innerHTML = parseFloat(
		hits[1] / total
	).toFixed(2);
	document.getElementById("hit-four").innerHTML = parseFloat(
		hits[2] / total
	).toFixed(2);
	document.getElementById("hit-eight").innerHTML = parseFloat(
		hits[3] / total
	).toFixed(2);

	document.getElementById("miss-one").innerHTML = parseFloat(
		misses[0] / total
	).toFixed(2);
	document.getElementById("miss-two").innerHTML = parseFloat(
		misses[1] / total
	).toFixed(2);
	document.getElementById("miss-four").innerHTML = parseFloat(
		misses[2] / total
	).toFixed(2);
	document.getElementById("miss-eight").innerHTML = parseFloat(
		misses[3] / total
	).toFixed(2);
	...
	document.getElementsByClassName("one")[indexTwoWay].innerHTML = Object.keys(
		lruTwo.cacheMap
	)[0]
		? Object.keys(lruTwo.cacheMap)[0]
		: "";
	document.getElementsByClassName("two")[indexTwoWay].innerHTML = Object.keys(
		lruTwo.cacheMap
	)[1]
	...
	document.getElementsByClassName("1")[indexFourWay].innerHTML = Object.keys(
		lruFour.cacheMap
	)[0]
		? Object.keys(lruFour.cacheMap)[0]
		: "";
	document.getElementsByClassName("2")[indexFourWay].innerHTML = Object.keys(
		lruFour.cacheMap
	)[1]
		? Object.keys(lruFour.cacheMap)[1]
		: "";
	document.getElementsByClassName("3")[indexFourWay].innerHTML = Object.keys(
		lruFour.cacheMap
	)[2]
		? Object.keys(lruFour.cacheMap)[2]
		: "";
	document.getElementsByClassName("4")[indexFourWay].innerHTML = Object.keys(
		lruFour.cacheMap
	)[3]
	...
	document.getElementsByClassName("11")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[0]
		? Object.keys(lruEight.cacheMap)[0]
		: "";
	document.getElementsByClassName("22")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[1]
		? Object.keys(lruEight.cacheMap)[1]
		: "";
	document.getElementsByClassName("33")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[2]
		? Object.keys(lruEight.cacheMap)[2]
		: "";
	document.getElementsByClassName("44")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[3]
		? Object.keys(lruEight.cacheMap)[3]
		: "";
	document.getElementsByClassName("55")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[4]
		? Object.keys(lruEight.cacheMap)[4]
		: "";
	document.getElementsByClassName("66")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[5]
		? Object.keys(lruEight.cacheMap)[5]
		: "";
	document.getElementsByClassName("77")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[6]
		? Object.keys(lruEight.cacheMap)[6]
		: "";
	document.getElementsByClassName("88")[0].innerHTML = Object.keys(
		lruEight.cacheMap
	)[7]
